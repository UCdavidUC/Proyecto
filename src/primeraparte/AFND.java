...
public class AFND {
    ...
    public AFND (Estados estados, Alfabeto alfabeto, EInicial eInicial, EFinales eFinales, ArrayList<Transicion> transiciones) {
    ...
    public void print () {
        if (estados != null && alfabeto != null && eInicial != null && eFinales != null && transiciones != null) {
            System.out.println("Autómata Finito no Determinístico");
